...
\begin{figure}[h]%
    \captionsetup[subfigure]{labelformat=empty}
    \centering
    \subfloat[$X^8$]{{\includegraphics[scale=0.04]{./images/filtration/desc/x1.pdf}}}%
    \qquad \qquad
    \subfloat[$X^7$]{{\includegraphics[scale=0.04]{./images/filtration/desc/x2.pdf}}}%
    \qquad \qquad
    \subfloat[$X^6$]{{\includegraphics[scale=0.04]{./images/filtration/desc/x3.pdf}}}%

    \par\bigskip

    \subfloat[$X^5$]{{\includegraphics[scale=0.04]{./images/filtration/desc/x4.pdf}}}%
    \qquad \qquad
    \subfloat[$X^4$]{{\includegraphics[scale=0.04]{./images/filtration/desc/x5.pdf}}}%
    \qquad \qquad
    \subfloat[$X^3$]{{\includegraphics[scale=0.04]{./images/filtration/desc/x6.pdf}}}%

    \par\bigskip

    \subfloat[$X^2$]{{\includegraphics[scale=0.04]{./images/filtration/desc/x7.pdf}}}%
    \qquad \qquad
    \subfloat[$X^1$]{{\includegraphics[scale=0.04]{./images/filtration/desc/x8.pdf}}}%
    \qquad \qquad
    \subfloat[$X^0$]{{\includegraphics[scale=0.04]{./images/filtration/desc/x9.pdf}}}%
...
\begin{figure}[h]%
    ...
    \qquad
    \subfloat[Branch decomposition of the join tree.]{{\includegraphics[scale=0.12]{./images/w3x3/w3x3-join-tree-decomposition.pdf}}}%

    \subfloat[Ascending filtration.]{{\includegraphics[scale=0.08]{./images/filtration/asc-filtration.pdf}}}%
    \qquad
    \subfloat[Branch decomposition of the split tree.]{{\includegraphics[scale=0.12]{./images/w3x3/w3x3-split-tree-decomposition.pdf}}}%
