...
\begin{figure}[h]%
    \centering
    \subfloat[Original Data Set]{{\includegraphics[scale=0.3]{./images/chapter4/w3x3-grid.eps}}} \\%
    \qquad
    \subfloat[Contour Tree]{{\includegraphics[scale=0.35]{./images/w3x3.eps}}}%
    \qquad
    \subfloat[Branch Decomposition.]{{\includegraphics[scale=0.35]{./images/branch-decomposition-W3x3.eps}}}%
...
\begin{figure}[h]%
    \centering
    \subfloat[$X_1$]{{\includegraphics[scale=0.05]{./images/filtration/asc/x1.eps}}}%
    \qquad \qquad
    \subfloat[$X_2$]{{\includegraphics[scale=0.05]{./images/filtration/asc/x2.eps}}}%
    \qquad \qquad
    \subfloat[$X_3$]{{\includegraphics[scale=0.05]{./images/filtration/asc/x3.eps}}}%

    \subfloat[$X_4$]{{\includegraphics[scale=0.05]{./images/filtration/asc/x4.eps}}}%
    \qquad \qquad
    \subfloat[$X_5$]{{\includegraphics[scale=0.05]{./images/filtration/asc/x5.eps}}}%
    \qquad \qquad
    \subfloat[$X_6$]{{\includegraphics[scale=0.05]{./images/filtration/asc/x6.eps}}}%

    \subfloat[$X_7$]{{\includegraphics[scale=0.05]{./images/filtration/asc/x7.eps}}}%
    \qquad \qquad
    \subfloat[$X_8$]{{\includegraphics[scale=0.05]{./images/filtration/asc/x8.eps}}}%
    \qquad \qquad
    \subfloat[$X_9$]{{\includegraphics[scale=0.05]{./images/filtration/asc/x9.eps}}}%
...
\begin{figure}[h]%
    \centering
    \subfloat[$X^9$]{{\includegraphics[scale=0.05]{./images/filtration/desc/x1.eps}}}%
    \qquad \qquad
    \subfloat[$X^8$]{{\includegraphics[scale=0.05]{./images/filtration/desc/x2.eps}}}%
    \qquad \qquad
    \subfloat[$X^7$]{{\includegraphics[scale=0.05]{./images/filtration/desc/x3.eps}}}%

    \subfloat[$X^6$]{{\includegraphics[scale=0.05]{./images/filtration/desc/x4.eps}}}%
    \qquad \qquad
    \subfloat[$X^5$]{{\includegraphics[scale=0.05]{./images/filtration/desc/x5.eps}}}%
    \qquad \qquad
    \subfloat[$X^4$]{{\includegraphics[scale=0.05]{./images/filtration/desc/x6.eps}}}%

    \subfloat[$X^3$]{{\includegraphics[scale=0.05]{./images/filtration/desc/x7.eps}}}%
    \qquad \qquad
    \subfloat[$X^2$]{{\includegraphics[scale=0.05]{./images/filtration/desc/x8.eps}}}%
    \qquad \qquad
    \subfloat[$X^1$]{{\includegraphics[scale=0.05]{./images/filtration/desc/x9.eps}}}%
...
\begin{figure}[h]%
    \centering
    \subfloat[Ascending Filtration]{{\includegraphics[scale=0.08]{./images/filtration/asc-filtration.eps}}}%
    \qquad \qquad
    \subfloat[Descending Filtration]{{\includegraphics[scale=0.08]{./images/filtration/desc-filtration.eps}}}%
