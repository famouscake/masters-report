...
\begin{figure}[h]%
    \centering
    \subfloat[Join Tree.]{{\includegraphics[scale=0.1]{./images/w3x3/w3x3-join-tree.pdf}}}%
    \subfloat[Branch Decomposition.]{{\includegraphics[scale=0.1]{./images/w3x3/w3x3-join-tree-decomposition.pdf}}}%
...
\begin{figure}[h]%
    \centering
    \subfloat[Split Tree.]{{\includegraphics[scale=0.1]{./images/w3x3/w3x3-split-tree.pdf}}}%
    \subfloat[Branch Decomposition.]{{\includegraphics[scale=0.1]{./images/w3x3/w3x3-split-tree-decomposition.pdf}}}%
...
\begin{figure}[h]%
    \centering
    \subfloat[Contour Tree.]{{\includegraphics[scale=0.1]{./images/w3x3/w3x3-contour-tree.pdf}}}%
    \subfloat[Branch Decomposition.]{{\includegraphics[scale=0.1]{./images/w3x3/w3x3-contour-tree-h-decomposition.pdf}}}%
...
\begin{figure}[h]%
    ...
    \centering
    \subfloat[$X_0$]{{\includegraphics[scale=0.04]{./images/filtration/asc/x1.pdf}}}%
    \qquad
    \subfloat[$X_1$]{{\includegraphics[scale=0.04]{./images/filtration/asc/x2.pdf}}}%
    \qquad
    \subfloat[$X_2$]{{\includegraphics[scale=0.04]{./images/filtration/asc/x3.pdf}}}%

    \par\bigskip

    \subfloat[$X_3$]{{\includegraphics[scale=0.04]{./images/filtration/asc/x4.pdf}}}%
    \qquad
    \subfloat[$X_4$]{{\includegraphics[scale=0.04]{./images/filtration/asc/x5.pdf}}}%
    \qquad
    \subfloat[$X_5$]{{\includegraphics[scale=0.04]{./images/filtration/asc/x6.pdf}}}%

    \par\bigskip

    \subfloat[$X_6$]{{\includegraphics[scale=0.04]{./images/filtration/asc/x7.pdf}}}%
    \qquad
    \subfloat[$X_7$]{{\includegraphics[scale=0.04]{./images/filtration/asc/x8.pdf}}}%
    \qquad
    \subfloat[$X_8$]{{\includegraphics[scale=0.04]{./images/filtration/asc/x9.pdf}}}%
...
\begin{figure}[h]%
    \captionsetup[subfigure]{labelformat=empty}
    \centering
    \subfloat[$X^9$]{{\includegraphics[scale=0.04]{./images/filtration/desc/x1.pdf}}}%
    \qquad \qquad
    \subfloat[$X^8$]{{\includegraphics[scale=0.04]{./images/filtration/desc/x2.pdf}}}%
    \qquad \qquad
    \subfloat[$X^7$]{{\includegraphics[scale=0.04]{./images/filtration/desc/x3.pdf}}}%

    \par\bigskip

    \subfloat[$X^6$]{{\includegraphics[scale=0.04]{./images/filtration/desc/x4.pdf}}}%
    \qquad \qquad
    \subfloat[$X^5$]{{\includegraphics[scale=0.04]{./images/filtration/desc/x5.pdf}}}%
    \qquad \qquad
    \subfloat[$X^4$]{{\includegraphics[scale=0.04]{./images/filtration/desc/x6.pdf}}}%

    \par\bigskip

    \subfloat[$X^3$]{{\includegraphics[scale=0.04]{./images/filtration/desc/x7.pdf}}}%
    \qquad \qquad
    \subfloat[$X^2$]{{\includegraphics[scale=0.04]{./images/filtration/desc/x8.pdf}}}%
    \qquad \qquad
    \subfloat[$X^1$]{{\includegraphics[scale=0.04]{./images/filtration/desc/x9.pdf}}}%
...
We can see that in this example the two computations are equivalent. This does indeed make intuitive sense. The join tree captures topological information of how the connectivity of superlevel sets changes and so does the 0th extended persistent homology of the descending filtration. The same holds for the split tree and the 0th extended persistence of the ascending filtration. This is further supported by the fact that the book \cite{comp-topo} describes an algorithm for computing the 0th persistent homology that is almost identical to the algorithm for computing join/split trees. Whether they are equivalent latter remains to be proven rigorously in the general case.
