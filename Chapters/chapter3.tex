...
\begin{figure}[h]%
    \centering
    \subfloat[Simplicial Mesh]{{\includegraphics[scale=0.4]{./images/w3x3-grid.eps}}}%
    \qquad \qquad \qquad
    \subfloat[Contour Tree]{{\includegraphics[scale=0.4]{./images/w3x3-contour-tree.eps}}}%
    \qquad \qquad \qquad

    \subfloat[Join Tree]{{\includegraphics[scale=0.4]{./images/w3x3-join-tree.eps}}}%
    \qquad \qquad \qquad
    \subfloat[Split Tree]{{\includegraphics[scale=0.4]{./images/w3x3-split-tree.eps}}}%
