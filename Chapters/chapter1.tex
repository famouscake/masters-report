...
\textbf{Step 1.} Triangulate the input mesh.

\textbf{Step 2.} Compute the Join and Split Tree of the input mesh.

\textbf{Step 3.} Iteratively prune leaves from the Join and Split tree and add them to the Contour Tree.

\textbf{Step 4.} Output Contour Tree.
