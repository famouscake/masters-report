...
\begin{figure}%
    ...
    \qquad
    \subfloat[Monotone decomposition $P_1 = 1, 2, 3$, $P_2 = 3, 4, 5, 6$ and $P_3 = 6, 7$.]{{\includegraphics[scale=0.5]{./images/w-path-decomposed.eps}}}%
...
\begin{figure}%
    ...
    \qquad
    \subfloat[Pathological Example for Case 2 (-2 of actual 2-diameter).]{{\includegraphics[scale=0.4 ]{./images/2xbfs-path-case-2.eps}}}%
