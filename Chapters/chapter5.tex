...
The \em chain complex \em of $X$ is made up of the following vector spaces and linear maps between them:
...
\begin{itemize}
    ...
    \item The \textbf{boundary maps} of the n-chains of $X$. These are linear maps between consecutive vector spaces of n chains and n-1 chains $\partial_n : C_n(X) \to C_{n-1}(X)$.
