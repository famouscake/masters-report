...
\begin{figure}[h]%
    \centering
    \subfloat[$X_1$]{{\includegraphics[scale=0.05]{./images/filtration/small/x1.eps}}}%
    \qquad
    \subfloat[$X_2$]{{\includegraphics[scale=0.05]{./images/filtration/small/x2.eps}}}%
    \qquad
    \subfloat[$X_3$]{{\includegraphics[scale=0.05]{./images/filtration/small/x3.eps}}}%
    \qquad
    \subfloat[$X_4$]{{\includegraphics[scale=0.05]{./images/filtration/small/x4.eps}}}%
    \qquad
    \subfloat[$X_5 = X$]{{\includegraphics[scale=0.05]{./images/filtration/small/x5.eps}}}%
...
\begin{figure}[h]%
    \centering
    \subfloat[Barcode Diagram]{{\includegraphics[scale=0.12]{./images/filtration/small/barcode.eps}}}%
    \qquad \qquad\qquad\qquad
    \subfloat[Pairs in $H_0$]{{\includegraphics[scale=0.1]{./images/filtration/small/diagram-h0.eps}}}%
    \qquad
    \subfloat[Pairs in $H_1$]{{\includegraphics[scale=0.1]{./images/filtration/small/diagram-h1.eps}}}%
