...
\begin{figure}[h]%
    \centering
    \subfloat[Persistence pairs in $H_0$.]{{\includegraphics[scale=0.07]{./images/filtration/small/diagram-h0.eps}}}%
    \qquad
    \subfloat[Persistence pairs in $H_1$.]{{\includegraphics[scale=0.07]{./images/filtration/small/diagram-h1.eps}}}%
    \subfloat[Barcode Diagram.]{{\includegraphics[scale=0.07]{./images/filtration/small/barcode.pdf}}}%
