...
% For putting two figures on the same line
\usepackage{subfig}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Details of your dissertation
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\projectTitle}{W-Structures in Contour Trees}
\newcommand{\fullname}{Petar Hristov}
\newcommand{\degreeTitle}{Mathematics and Computer Science MSc}
\newcommand{\session}{Session 2016/2017}
